...
--
-- Host: localhost    Database: db_sie
-- ------------------------------------------------------
...
INSERT INTO `aspiration` VALUES (9,2,'a','a','female',1,0,'a',0,'a@gmail.com','a',0,'a','a','Java','a','a',1,'a','a','a','b','bb@gmali.com');
...
INSERT INTO `comment` VALUES (2,2,'aa','aa');
...
INSERT INTO `cv` VALUES (2,2,'dfd dfdfdf','sdfsdf','male',0,'sdf@slkfjsd','sdfds','sdff','sdfsds','dfsd','sdf');
...
INSERT INTO `registration` VALUES (2,5,'Tren troi','Tren troi','Nhat','nhat@gmail.com','123456789',500,'No','No');
...
CREATE TABLE `speciality` (
  ...
  KEY `idSpeciality_3` (`idSpeciality`,`CompanyID`,`name`),
  KEY `CompanyID` (`CompanyID`),
  CONSTRAINT `speciality_ibfk_1` FOREIGN KEY (`CompanyID`) REFERENCES `company` (`idCompany`)
...
INSERT INTO `speciality` VALUES (1,1,'Java'),(2,1,'C#'),(3,1,'Android'),(4,1,'PHP'),(5,1,'QA');
...
INSERT INTO `topic` VALUES (30,1,1,'aaaaaaaaa',1),(31,2,1,'bbbbbbbbb',14),(32,2,1,'ccccccccc',1),(33,3,1,'ddddddddddd',2),(34,1,1,'eeeeeeeee',23);
...
INSERT INTO `user` VALUES (1,'admin@gmail.com','123456',1,''),(2,'student@gmail.com','123456',2,''),(3,'collegeinstructor@gmail.com','123456',3,''),(4,'collegeintershipmanager@gmail.com','123456',4,''),(5,'companyrepresentative@gmail.com','123456',5,''),(6,'companyinstructor@gmail.com','123456',6,'');
...
-- Dump completed on 2017-05-18 22:11:57
