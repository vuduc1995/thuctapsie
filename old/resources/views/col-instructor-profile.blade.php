...
<head>
  ...
  <meta charset= "utf-8">
    <title>College Instructor Profile Page</title>

    <link rel ="stylesheet" type="text/css" href ="{{ URL::asset('css/font-awesome.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('data/col.instructor-edit-profile/css/styles.css') }}">
              ...
              <ul class="btn dropdown-toggle menubar" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
               <li class="">  
                  ...
                  <span class ="userbutton">
                    <span class ="usertext">College Instructor
                    </span>
                    <span class ="avatar">
