...
<head>
  ...
  <meta charset= "utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('data/col.manager-schedule/css/styles.css') }}">
        ...
        <h2>schedule</h2>
                  ...
                  @foreach($list as $i=>$item)
                    ...
                    <tr>
                      ...
                      <td>
                      <select name="topicListTime_{{$i}}" >
    
                      <option value="1" >Time Course 1</option>
                      <option value="2" >Time Course 2</option>
                      </select></td>
                    </tr>
...
<script type="text/javascript">
    ...
    e.preventDefault();
    $.ajax({
        url:'/collegeintershipmanager/upSchedule',
        type:'post',
