@include('includes.head', array('cssFolder' => 'col.instructor-mark-stud-1'))
<body>
...
<div class="form-register">
 ...
 -->
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6 control-label" >
                  <label class="col-sm-4 control-label" style="text-align: left;"><a href="/companyinstructor/rate-2/{{$student['id']}}">{{$i+1}}. {{$student['name']}}</a></label>
