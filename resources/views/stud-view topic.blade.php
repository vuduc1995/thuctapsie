...
<head>
  ...
  <meta charset= "utf-8">
    <title>Student Topic</title>

     <link rel ="stylesheet" type="text/css" href ="{{ URL::asset('css/font-awesome.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('data/stud-view topic/css/styles.css') }}">
            ...
            <div class="dropdown wrap-item">
              ...
              <ul class="dropdown-menu hidemenu" aria-labelledby="dropdownMenu1">
               <li>
                ...
                <li>
                  <a class ="menu-action" href="/student/profile">
      ...
      <div class="row-fluid">
          ...
          <div class="infoarea">
            <div class="footer-logo">
              <a href="hust">
                <img src="{{ URL::asset('images/logo60nambk.png') }}" width="89" height="56" alt="footer-logo">
              </a>
            </div>
